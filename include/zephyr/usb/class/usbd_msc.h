 ...
 * Up to :kconfig:option:`CONFIG_USBD_MSC_LUNS_PER_INSTANCE` disks can be
 * registered on single USB MSC instance. Currently only one USB MSC instance
 * is supported.
 *
 * @param disk Disk name accessible through :ref:`disk_access_api`
