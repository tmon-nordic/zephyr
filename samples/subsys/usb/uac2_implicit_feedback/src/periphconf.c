...
UICR_SPU_FEATURE_DPPIC_CH_SET(0x5f920000UL, 0, false, NRF_OWNER_APPLICATION);
/* SPU131 feature configuration for DPPIC130 ch. 3 */
UICR_SPU_FEATURE_DPPIC_CH_SET(0x5f920000UL, 3, false, NRF_OWNER_APPLICATION);
/* SPU131 feature configuration for DPPIC130 ch. 4 */
UICR_SPU_FEATURE_DPPIC_CH_SET(0x5f920000UL, 4, false, NRF_OWNER_APPLICATION);
/* SPU133 feature configuration for DPPIC132 ch. 0 */
UICR_SPU_FEATURE_DPPIC_CH_SET(0x5f990000UL, 0, false, NRF_OWNER_APPLICATION);
/* SPU134 feature configuration for DPPIC133 ch. 0 */
UICR_SPU_FEATURE_DPPIC_CH_SET(0x5f9a0000UL, 0, true, NRF_OWNER_APPLICATION);
/* SPU134 feature configuration for DPPIC133 ch. 1 */
UICR_SPU_FEATURE_DPPIC_CH_SET(0x5f9a0000UL, 1, true, NRF_OWNER_APPLICATION);
/* SPU134 feature configuration for DPPIC133 ch. 2 */
UICR_SPU_FEATURE_DPPIC_CH_SET(0x5f9a0000UL, 2, true, NRF_OWNER_APPLICATION);
/* SPU134 feature configuration for DPPIC133 ch. 3 */
UICR_SPU_FEATURE_DPPIC_CH_SET(0x5f9a0000UL, 3, true, NRF_OWNER_APPLICATION);
/* SPU134 feature configuration for DPPIC133 ch. 4 */
UICR_SPU_FEATURE_DPPIC_CH_SET(0x5f9a0000UL, 4, true, NRF_OWNER_APPLICATION);
...
/* PPIB130 ch. 17 => PPIB134 ch. 1 */
UICR_PPIB_SUBSCRIBE_SEND_ENABLE(0x5f925000UL, 17);
UICR_PPIB_PUBLISH_RECEIVE_ENABLE(0x5f9ad000UL, 1);
/* PPIB130 ch. 18 => PPIB134 ch. 2 */
UICR_PPIB_SUBSCRIBE_SEND_ENABLE(0x5f925000UL, 18);
UICR_PPIB_PUBLISH_RECEIVE_ENABLE(0x5f9ad000UL, 2);
/* PPIB134 ch. 3 => PPIB130 ch. 19 */
UICR_PPIB_SUBSCRIBE_SEND_ENABLE(0x5f9ad000UL, 3);
UICR_PPIB_PUBLISH_RECEIVE_ENABLE(0x5f925000UL, 19);
/* PPIB134 ch. 4 => PPIB130 ch. 20 */
UICR_PPIB_SUBSCRIBE_SEND_ENABLE(0x5f9ad000UL, 4);
UICR_PPIB_PUBLISH_RECEIVE_ENABLE(0x5f925000UL, 20);
...
/* SPU131 feature configuration for 0x5f938200UL, P1.0 */
UICR_SPU_FEATURE_GPIO_PIN_SET(0x5f920000UL, 1, 0, true, NRF_OWNER_APPLICATION);
/* SPU131 feature configuration for 0x5f938200UL, P1.3 */
UICR_SPU_FEATURE_GPIO_PIN_SET(0x5f920000UL, 1, 3, true, NRF_OWNER_APPLICATION);
/* SPU131 feature configuration for 0x5f938200UL, P1.4 */
UICR_SPU_FEATURE_GPIO_PIN_SET(0x5f920000UL, 1, 4, true, NRF_OWNER_APPLICATION);
/* SPU131 feature configuration for 0x5f938200UL, P1.5 */
UICR_SPU_FEATURE_GPIO_PIN_SET(0x5f920000UL, 1, 5, true, NRF_OWNER_APPLICATION);
/* SPU131 feature configuration for 0x5f938200UL, P1.6 */
...
/* SPU131 feature configuration for 0x5f938000UL, P0.2 */
UICR_SPU_FEATURE_GPIO_PIN_SET(0x5f920000UL, 0, 2, true, NRF_OWNER_APPLICATION);
/* SPU131 feature configuration for 0x5f938000UL, P0.3 */
UICR_SPU_FEATURE_GPIO_PIN_SET(0x5f920000UL, 0, 3, true, NRF_OWNER_APPLICATION);
/* SPU131 feature configuration for 0x5f938000UL, P0.4 */
UICR_SPU_FEATURE_GPIO_PIN_SET(0x5f920000UL, 0, 4, true, NRF_OWNER_APPLICATION);
/* SPU131 feature configuration for 0x5f938000UL, P0.5 */
UICR_SPU_FEATURE_GPIO_PIN_SET(0x5f920000UL, 0, 5, true, NRF_OWNER_APPLICATION);
/* SPU131 feature configuration for 0x5f938000UL, P0.6 */
UICR_SPU_FEATURE_GPIO_PIN_SET(0x5f920000UL, 0, 6, true, NRF_OWNER_APPLICATION);
/* SPU131 feature configuration for 0x5f938000UL, P0.7 */
UICR_SPU_FEATURE_GPIO_PIN_SET(0x5f920000UL, 0, 7, true, NRF_OWNER_APPLICATION);
...
/* 0x5f939200UL - P9.4 CTRLSEL = 0 */
UICR_GPIO_PIN_CNF_CTRLSEL_SET(0x5f939200UL, 4, 0);
/* 0x5f939200UL - P9.5 CTRLSEL = 0 */
UICR_GPIO_PIN_CNF_CTRLSEL_SET(0x5f939200UL, 5, 0);
...
/* 0x5f938200UL - P1.0 CTRLSEL = 0 */
UICR_GPIO_PIN_CNF_CTRLSEL_SET(0x5f938200UL, 0, 0);
/* 0x5f938200UL - P1.3 CTRLSEL = 5 */
UICR_GPIO_PIN_CNF_CTRLSEL_SET(0x5f938200UL, 3, 5);
/* 0x5f938200UL - P1.4 CTRLSEL = 5 */
UICR_GPIO_PIN_CNF_CTRLSEL_SET(0x5f938200UL, 4, 5);
/* 0x5f938200UL - P1.5 CTRLSEL = 5 */
UICR_GPIO_PIN_CNF_CTRLSEL_SET(0x5f938200UL, 5, 5);
/* 0x5f938200UL - P1.6 CTRLSEL = 5 */
UICR_GPIO_PIN_CNF_CTRLSEL_SET(0x5f938200UL, 6, 5);
...
/* 0x5f938000UL - P0.2 CTRLSEL = 0 */
UICR_GPIO_PIN_CNF_CTRLSEL_SET(0x5f938000UL, 2, 0);
/* 0x5f938000UL - P0.3 CTRLSEL = 0 */
UICR_GPIO_PIN_CNF_CTRLSEL_SET(0x5f938000UL, 3, 0);
/* 0x5f938000UL - P0.4 CTRLSEL = 0 */
UICR_GPIO_PIN_CNF_CTRLSEL_SET(0x5f938000UL, 4, 0);
/* 0x5f938000UL - P0.5 CTRLSEL = 0 */
UICR_GPIO_PIN_CNF_CTRLSEL_SET(0x5f938000UL, 5, 0);
/* 0x5f938000UL - P0.6 CTRLSEL = 0 */
UICR_GPIO_PIN_CNF_CTRLSEL_SET(0x5f938000UL, 6, 0);
/* 0x5f938000UL - P0.7 CTRLSEL = 0 */
UICR_GPIO_PIN_CNF_CTRLSEL_SET(0x5f938000UL, 7, 0);
...
/* SPU134 configuration for 0x5f9a3000UL */
UICR_SPU_PERIPH_PERM_SET(0x5f9a0000UL, 3, true, false, NRF_OWNER_APPLICATION);
...
/* SPU133 configuration for 0x5f992000UL */
UICR_SPU_PERIPH_PERM_SET(0x5f990000UL, 2, true, true, NRF_OWNER_APPLICATION);
/* 0xbf003000UL IRQ => APPLICATION */
UICR_IRQMAP_IRQ_SINK_SET(127, NRF_PROCESSOR_APPLICATION);
...
/* 0x5f8d4000UL IRQ => FLPR */
UICR_IRQMAP_IRQ_SINK_SET(212, NRF_PROCESSOR_FLPR);
...
/* 0x5f9a3000UL IRQ => APPLICATION */
UICR_IRQMAP_IRQ_SINK_SET(419, NRF_PROCESSOR_APPLICATION);
...
/* 0x5f992000UL IRQ => APPLICATION */
UICR_IRQMAP_IRQ_SINK_SET(402, NRF_PROCESSOR_APPLICATION);